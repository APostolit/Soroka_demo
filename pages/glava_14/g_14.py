...
def kino(option):
    try:
        video_url = None
        if option == 'Листинг 14.1':  #У лукоморья
...
st.set_page_config(
    page_title="Тема 14", # Текст на вкладке браузера
...
with cont_1:
    ...
    options = st.selectbox("Листинги темы 14",
        ("Листинг 14.1", "Листинг 14.2", "Листинг 14.3", ),
        index=None,
...
with cont_2:
    ...
    elif options == "Листинг 14.1":  # Целые числа
    ...
    elif options == "Листинг 14.2":  # Целые числа
        col1, col2 = st.columns([2, 0.1], width=700)
        with col1:
            pass
        with col2:
            pass
    ...
    elif options == "Листинг 14.3":  # Целые числа
        col1, col2 = st.columns([2, 0.1], width=700)
        with col1:
            pass
        with col2:
